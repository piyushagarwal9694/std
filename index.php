  ...
  <div class="container">
    ...
    <form action="php/feedback.php" method="post" class="student-form">
      <div class="student-details">
        ...
        <select id="branch" name="branch" onchange="updateCities()">
...
<!-- 
        ...
        <!-- <select name="subject" id="subject">
          ...
          <option value="ATCD">Automata Theory And Compiler Design</option>
        </select> -->
...
<script>
  ...
  function updateCities() {
    ...
    const selectedCountry = document.getElementById("branch").value;

    // Get the city dropdown element
    const cityDropdown = document.getElementById("subject");
  ...
  // Initialize cities based on the default selected country
  updateCities();
</script>